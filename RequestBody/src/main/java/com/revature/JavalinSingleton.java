...
public class JavalinSingleton {
    ...
    public static Javalin getInstance(){
        ...
        app.post("/problem1", ctx -> {
                ...
                Song varSong = om.readValue(songString, Song.class);
                
                String returnString = om.writeValueAsString(varSong.getArtistName());

                ctx.result(varSong.getArtistName());
                //ctx.result(returnString);
        });
